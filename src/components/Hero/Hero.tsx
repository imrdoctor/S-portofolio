      ...
      <div className="flex flex-col items-center justify-center gap-6 h-[65vh]">
        ...
        <div className="container mx-auto px-4  mb-36">
          <div className="container mx-auto px-4">
            <h1
              className="text-3xl z sm:text-4xl md:text-5xl overflow-visible h-[111px] lg:text-7xl xl:text-8xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-b from-gray-400 to-gray-200  leading-snug sm:leading-normal md:leading-relaxed "
            >
